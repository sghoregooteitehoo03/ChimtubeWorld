package com.sghore.chimtubeworld.presentation.ui.custom
...
class SpannableGridLayoutManager : RecyclerView.LayoutManager {
    ...
    private var cellBorders: IntArray = intArrayOf()
    ...
    constructor(
        ...
        val a: TypedArray = context.obtainStyledAttributes(
            attrs,
            R.styleable.SpannableGridLayoutManager,
            defStyleAttr,
            defStyleRes
        )
        ...
        val orientation = a.getInt(
            R.styleable.SpannableGridLayoutManager_android_orientation,
    ...
    override fun computeVerticalScrollRange(state: RecyclerView.State): Int {
        ...
        return getSpannedRowCount() * cellHeight + paddingTop + paddingBottom
    }
    ...
    override fun findViewByPosition(position: Int): View? {
        return if (position < firstVisiblePosition || position > lastVisiblePosition) null else getChildAt(
    ...
    private fun getSpannedRowCount(): Int {
    ...
    private fun getLastPositionInSpannedRow(rowIndex: Int, state: RecyclerView.State): Int {
        ...
        return if (nextRow != getSpannedRowCount()) // check if reached boundary
    ...
    private fun recycleRow(
        ...
        while (toRemove >= firstPositionInRow) {
            val index = toRemove - firstVisiblePosition
    ...
    private fun resetVisibleItemTracking() {
        ...
        val minimumVisibleRow = getMinimumFirstVisibleRow()
    ...
    private fun getMinimumFirstVisibleRow(): Int {
